...
import com.mrappstore.mushfik.friends.activity.ProfileActivity.PerformAction;
...
public class FriendRequestAdapter extends
    ...
    private void actionPerfom(final String uid) {
        ...
        Call<Integer> call = userInterface.performAction(new ProfileActivity
                .PerformAction(3 + "",FirebaseAuth.getInstance().getCurrentUser().getUid(),uid));
